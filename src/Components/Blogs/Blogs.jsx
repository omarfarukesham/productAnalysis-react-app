          ...
          >
            <div className="accordion-body">
              <h5>
                  ...
                  complex.To avoid props drillings, context api in React truly an efficient process in which, data passing
                  parent to child or child to parents make more ease and perfect, that's Context Api.Data in an application of 
                  React  can moving whenever needed, just following simple steps.
              </h5>
            </div>
          </div>
        </div>
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
             ...
             available width from next to their position. for instance, span tag is a inline elements.</p>
